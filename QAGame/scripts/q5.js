...
function shuffle(array){
    var btns = ['Marie Curie', 'Albert Einstein', 'Nikola Tesla', 'Benjamin Franklin', 'Isaac Newton']
...
function acerto(){
    ...
    msg.textContent = 'VOCÊ ACERTOU TUDO!';
    ...
    prosseguir.textContent = 'Receba seu prêmio!'
    prosseguir.href = 'prize.html';
